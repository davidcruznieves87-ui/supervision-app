...
import { generarPDFIncidenciasNomina } from "../services/nomina/pdfIncidenciasNomina";
...
const resumenSemanal =
    ...
    async () => {
      ...
      const confirmar =
        window.confirm(
          ...
          "También se generará automáticamente el PDF de incidencias."
        );
      ...
      try {
        ...
        // =============================================
        // CERRAR Y OBTENER SNAPSHOT FINAL
        // =============================================
        ...
        // =============================================
        // GENERAR PDF DE INCIDENCIAS
        // =============================================

        try {

          generarPDFIncidenciasNomina(
            nominaCerrada
          );
          ...
          console.error(
            "Error generando PDF de incidencias:",
            pdfError
          );

          // IMPORTANTE:
          // Si falla el PDF, la Nómina permanece cerrada.
          // No lanzamos error para evitar indicar que
          // el cierre completo falló.
        }
        ...
        setMensaje(
          "🔒 Nómina cerrada correctamente. PDF de incidencias generado."
        );
  ...
  const descargarPDFNominaHistorica = () => {
    ...
    // ===================================================
  // PDF INCIDENCIAS NÓMINA HISTÓRICA
  // ===================================================

  const descargarPDFIncidenciasHistorica = () => {
    ...
    try {
      ...
      setError(
        err?.message ||
          "No fue posible generar el PDF de incidencias."
      );
    }
  };
              ...
              <div style={theme.card}>
                ...
                >
                  ...
                  >
                    ...
                    <button
  onClick={
    descargarPDFIncidenciasHistorica
  }
  style={
    theme.button.primary
  }
